  ...
  return (
    <>
      ...
      <section className="lg:grid lg:grid-cols-2 lg:gap-8 lg:mt-4 md:gap-16">
        ...
        <div
          className={`border-2 border-gray-400 shadow-2xl drop-shadow-lg rounded p-2 lg:p-0 mb-6`}
        >
        ...
        <div className=" border-2 border-gray-400 shadow-2xl inset-shadow-zinc-500 drop-shadow-lg rounded p-2 lg:p-0 mb-6 ">
          {/* TASK STATUS*/}
          <div className="border-amber-200 border-2 mb-4 p-2 rounded-lg bg-white">
          ...
          <div className=" border-gray-900 border-2 not-only-of-type:flex flex-col justify-center items-center p-2 gap-3 rounded-lg lg:bg-neutral-700">
            {/** <div className="">*/}
